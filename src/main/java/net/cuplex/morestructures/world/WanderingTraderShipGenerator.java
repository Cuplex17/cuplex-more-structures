...
public class WanderingTraderShipGenerator
{
    ...
    public static class Piece extends SimpleStructurePiece {
        ...
        protected void handleMetadata(String string_1, BlockPos blockPos, IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox)
        {
            ...
            {
                wanderingTraderEntity = (WanderingTraderEntity) EntityType.WANDERING_TRADER.create(iWorld.getWorld());
            }
            else if("villager".equals(string_1))
            {
                villagerEntity = (VillagerEntity) EntityType.VILLAGER.create(iWorld.getWorld());
            }
            ...
            villagerEntity.initialize(iWorld, iWorld.getLocalDifficulty(new BlockPos(villagerEntity)), SpawnType.STRUCTURE, (EntityData)null, (CompoundTag)null);
            wanderingTraderEntity.initialize(iWorld, iWorld.getLocalDifficulty(new BlockPos(wanderingTraderEntity)), SpawnType.STRUCTURE, (EntityData)null, (CompoundTag)null);
